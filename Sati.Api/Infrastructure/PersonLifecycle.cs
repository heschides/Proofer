...
internal sealed class PersonLifecycle(ApiDbContext db, IHttpContextAccessor httpContextAccessor)
{
    ...
    [
        ...
        new("credibleClientId", "Credible client ID", value => value.CredibleClientId),
        new("openWithVR", "Open with VR", value => value.OpenWithVR),
        new("vrCounselorName", "VR counselor", value => value.VrCounselorName),
        new("vrAssistantName", "VR assistant", value => value.VrAssistantName),
        ...
        new("email", "Email", value => value.Email),
        ...
        new("caseManagerIsDhhsRepresentative", "Case manager is DHHS representative", value => value.CaseManagerIsDhhsRepresentative),
        new("usesModivcare", "Uses Modivcare", value => value.UsesModivcare),
...
internal sealed record PersonSnapshot(
    ...
    bool OpenWithVR,
    string? VrCounselorName,
    string? VrAssistantName,
    bool HasGuardian,
    string? GuardianName,
    string? PhoneNumber,
    string? Email,
    ...
    bool CaseManagerIsDhhsRepresentative,
    bool UsesModivcare,
