# Compare the EF model (SatiContextModelSnapshot.cs) against the schema the migration
# chain actually produced. Any column the model expects but the database lacks is drift:
# it works on a hand-patched database and fails on a fresh one.
param(
